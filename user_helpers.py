...
# 
#   In order to properly equip the Albatross layer, we need the user's location.
...
#   This allows us to accurate find other DNS servers near their location 
#   from which Albatross verifies an IP.
...
#
#   Inputs the data sent back to the user by Albatross of "warnings."
#   Creates and opens a visualizing tool to give the user a visual representation of the concerns of 
#   certain domains having accurate IPs.
...
def visualize_results(data):
    ...
    for i in range(num_categories):
        ax.barh(index + bar_offset[i], [match_counts[domain_idx][i] for domain_idx in range(num_domains)], bar_height,
                alpha=opacity,
...
# How to use / an example of testing:
# print(get_user_country())
# valid_query("www.youtube.com")